...
**Post and pre (dummies)
gen pre2011=1 if Parliament<401
gen post2011=1 if Parliament >41 
***Second column
mean declaredwinner if Party1==1 & pre2011==1
***Linear
reg declaredwinner dummyMVPrev MVPrev i.dummyMVPrev#c.MVPrev Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party1 ==1 & pre2011==1 & MVPrev <=0.15 & MVPrev >=-0.15, cluster(Constituency)
outreg2 using results2, word replace ctitle(model1) stat(coef se) alpha(0.01, 0.05,0.1) symbol(***, **, *) keep(dummyMVPrev)

reg declaredwinner dummyMVPrev MVPrev i.dummyMVPrev#c.MVPrev Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party1 ==1 & pre2011==1 & MVPrev <=0.1 & MVPrev >=-0.1, cluster(Constituency)
outreg2 using results2, word append ctitle(model2) stat(coef se) alpha(0.01, 0.05,0.1) symbol(***, **, *) keep(dummyMVPrev)

***Cubic
reg declaredwinner dummyMVPrev MVPrev realmvprev2 realmvprev3 i.dummyMVPrev#c.MVPrev i.dummyMVPrev#c.realmvprev2 i.dummyMVPrev#c.realmvprev3 Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party1 ==1 & pre2011==1 & MVPrev<=0.7 & MVPrev>=-0.7, cluster(Constituency)
outreg2 using results2, word append ctitle(model3) stat(coef se) alpha(0.01, 0.05,0.1) symbol(***, **, *) keep(dummyMVPrev)

***Quartic
reg declaredwinner dummyMVPrev MVPrev realmvprev2 realmvprev3 realmvprev4 i.dummyMVPrev#c.MVPrev i.dummyMVPrev#c.realmvprev2 i.dummyMVPrev#c.realmvprev3 i.dummyMVPrev#c.realmvprev4 Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party1 ==1 & pre2011==1 & MVPrev<=0.7 & MVPrev>=-0.7, cluster(Constituency)
outreg2 using results2, word append ctitle(model4) stat(coef se) alpha(0.01, 0.05,0.1) symbol(***, **, *) keep(dummyMVPrev)

***Third column
mean declaredwinner if Party1==1 & post2011==1
***Linear
reg declaredwinner dummyMVPrev MVPrev i.dummyMVPrev#c.MVPrev Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party1 ==1 & post2011==1 & MVPrev <=0.15 & MVPrev >=-0.15, cluster(Constituency)
outreg2 using results2, word append ctitle(model5) stat(coef se) alpha(0.01, 0.05,0.1) symbol(***, **, *) keep(dummyMVPrev)

reg declaredwinner dummyMVPrev MVPrev i.dummyMVPrev#c.MVPrev Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party1 ==1 & post2011==1 & MVPrev <=0.1 & MVPrev >=-0.1, cluster(Constituency)
outreg2 using results2, word append ctitle(model6) stat(coef se) alpha(0.01, 0.05,0.1) symbol(***, **, *) keep(dummyMVPrev)

***Cubic
reg declaredwinner dummyMVPrev MVPrev realmvprev2 realmvprev3 i.dummyMVPrev#c.MVPrev i.dummyMVPrev#c.realmvprev2 i.dummyMVPrev#c.realmvprev3 Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party1 ==1 & post2011==1 & MVPrev<=0.7 & MVPrev>=-0.7, cluster(Constituency)
...
***Fourth column
mean declaredwinner if Party2==1 & pre2011==1
***Linear
reg declaredwinner dummyMVPrev MVPrev i.dummyMVPrev#c.MVPrev Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party2 ==1 & pre2011==1 & MVPrev <=0.15 & MVPrev >=-0.15, cluster(Constituency)
outreg2 using results2, word append ctitle(model9) stat(coef se) alpha(0.01, 0.05,0.1) symbol(***, **, *) keep(dummyMVPrev)

reg declaredwinner dummyMVPrev MVPrev i.dummyMVPrev#c.MVPrev Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party2 ==1 & pre2011==1 & MVPrev <=0.1 & MVPrev >=-0.1, cluster(Constituency)
outreg2 using results2, word append ctitle(model10) stat(coef se) alpha(0.01, 0.05,0.1) symbol(***, **, *) keep(dummyMVPrev)

***Cubic
reg declaredwinner dummyMVPrev MVPrev realmvprev2 realmvprev3 i.dummyMVPrev#c.MVPrev i.dummyMVPrev#c.realmvprev2 i.dummyMVPrev#c.realmvprev3 Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party2 ==1 & pre2011==1 & MVPrev<=0.7 & MVPrev>=-0.7, cluster(Constituency)
outreg2 using results2, word append ctitle(model11) stat(coef se) alpha(0.01, 0.05,0.1) symbol(***, **, *) keep(dummyMVPrev)

***Quartic
reg declaredwinner dummyMVPrev MVPrev realmvprev2 realmvprev3 realmvprev4 i.dummyMVPrev#c.MVPrev i.dummyMVPrev#c.realmvprev2 i.dummyMVPrev#c.realmvprev3 i.dummyMVPrev#c.realmvprev4 Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party2 ==1 & pre2011==1 & MVPrev<=0.7 & MVPrev>=-0.7, cluster(Constituency)
outreg2 using results2, word append ctitle(model12) stat(coef se) alpha(0.01, 0.05,0.1) symbol(***, **, *) keep(dummyMVPrev)

***Fifth column
mean declaredwinner if Party2==1 & post2011==1
***Linear
reg declaredwinner dummyMVPrev MVPrev i.dummyMVPrev#c.MVPrev Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party2 ==1 & post2011==1 & MVPrev <=0.15 & MVPrev >=-0.15, cluster(Constituency)
outreg2 using results2, word append ctitle(model13) stat(coef se) alpha(0.01, 0.05,0.1) symbol(***, **, *) keep(dummyMVPrev)

reg declaredwinner dummyMVPrev MVPrev i.dummyMVPrev#c.MVPrev Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party2 ==1 & post2011==1 & MVPrev <=0.1 & MVPrev >=-0.1, cluster(Constituency)
outreg2 using results2, word append ctitle(model14) stat(coef se) alpha(0.01, 0.05,0.1) symbol(***, **, *) keep(dummyMVPrev)

***Cubic
reg declaredwinner dummyMVPrev MVPrev realmvprev2 realmvprev3 i.dummyMVPrev#c.MVPrev i.dummyMVPrev#c.realmvprev2 i.dummyMVPrev#c.realmvprev3 Prov1 Prov2 Prov3 Prov4 Prov5 Prov6 Prov7 Prov8 Prov9 Prov10 Prov11 Prov12 Prov13 i.Parliament if Party2 ==1 & post2011==1 & MVPrev<=0.7 & MVPrev>=-0.7, cluster(Constituency)
